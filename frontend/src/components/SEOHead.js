...
const SEOHead = ({
  ...
  const defaultDescription =
    "Photographe professionnel spécialisé dans les paysages méditerranéens. Calanques & littoral méditerranéen, couchers de soleil et tirages d'art numérotés et signés.";
  ...
  const photographerSchema = {
    ...
    knowsAbout: [
      ...
      'Calanques et littoral méditerranéen',
      'Méditerranée',
      'Tirage Fine Art',
      'Coucher de soleil',
    ],
  ...
  return (
    <Helmet>
      ...
      <script type="application/ld+json">{JSON.stringify(photographerSchema)}</script>
