...
export const mockData = {
  photographer: {
    ...
    bio: "Photographe de paysage basé à Marseille, je travaille au rythme de la Méditerranée. Je photographie la rade, les calanques, les ports et les rivages de la Côte d’Azur, toujours avec la lumière réelle du moment. Pas de mise en scène, pas d’artifice. Seulement la mer, le ciel et la côte tels qu’ils se présentent. Ce qui m’intéresse, ce sont les instants calmes, les fins de journée, les horizons nets où tout s’aligne. La lumière du Sud, parfois dure, parfois douce, façonne chaque image. Chaque photographie est pensée pour être imprimée. Des tirages durables, destinés à s’intégrer dans des intérieurs sobres, contemporains ou méditerranéens. Mon travail met en valeur la Méditerranée dans ce qu’elle a de plus simple et de plus vrai : ses couleurs, ses lignes, ses silences." ,
